...
function renderBanner(bannerUrl){
    document.getElementById('bannerAd').textContent = bannerUrl;
}

/*
  TODO: Get the retreveal of ads to work
*/

function getBannerUrl(callback){
  //var bannerUrl = document.getElementByClassName('banner').style.backgroundImage;
  //alert(bannerUrl.substring(4, url.length-1)); 
